...
const papers = [
    {
        ...
        htmlFile:`${process.env.PUBLIC_URL}/src/papers/CoRAG_Chain of Retrieval Augmented Generation.html`,
        img: {
            src:`${process.env.PUBLIC_URL}/src/papers/assets/CoRAG_Chain of Retrieval Augmented Generation_0.png`,
            alt:"Research Paper"
        }
    },
    {
